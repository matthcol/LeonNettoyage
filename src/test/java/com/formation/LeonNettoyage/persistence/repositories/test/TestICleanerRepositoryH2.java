package com.formation.LeonNettoyage.persistence.repositories.test;
...
/**
 * Test ICleanerRepository with same database as application
 * @author Matthias
 *
 */
@DataJpaTest
class TestICleanerRepositoryH2 {
